...
def get_data(Sensors_Data: SensorsData, db : Session = Depends(get_db)): # Parameters- variable : pydantic model
...
def insert_data_to_SensorsTable(db:Session, device_MAC:str, data:dict):
